...
CREATE TABLE users (
    ...
    password            VARCHAR(255) NULL,                 -- 소셜 가입 시 NULL 허용
    phone               VARCHAR(255) NOT NULL,              -- 회원가입 시 필요, 아이디 찾기에 사용
    nickname            VARCHAR(50)  NOT NULL,
    profile_image       VARCHAR(255) NULL,
    provider            VARCHAR(20)  NOT NULL DEFAULT 'LOCAL',   -- LOCAL, GOOGLE, KAKAO
    provider_user_id    VARCHAR(100) NULL,                  -- 소셜 제공자 고유 식별 ID
    status              VARCHAR(20)  NOT NULL DEFAULT 'PENDING', -- PENDING, ACTIVE, DELETED
    subscription_level  VARCHAR(20)  NOT NULL DEFAULT 'FREE',    -- FREE, PRO, MAX
...
CREATE TABLE stock (
    id              BIGINT       NOT NULL AUTO_INCREMENT PRIMARY KEY,
    market_type     VARCHAR(20)  NOT NULL,                  -- KOSPI, KOSDAQ 등
...
CREATE TABLE community_posts (
    ...
    stock_code    VARCHAR(20)  NULL,                          -- stock.stock_code 참조(종목 토론방용)
